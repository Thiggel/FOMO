...
class ImageStorage:
    ...
    def save_images(self, images: List[Image.Image], cycle_idx: int, labels: List[int]) -> None:
        """
...
class ImbalancedImageNet(Dataset):
    def __init__(
        ...
        storage_path = os.path.join(os.environ["BASE_CACHE_DIR"], f"{checkpoint_filename}_generated_images.h5")
    ...
    def save_additional_datapoint(self, images: List[Image.Image], labels: List[int], cycle_idx: int):
