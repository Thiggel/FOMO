...
python -m experiment model=resnet50 ssl=simclr dataset=imagenet100_imbalanced num_cycles=8 total_epochs=800 use_temperature_schedule=true ood_augmentation=true experiment_name=sota_imagenet-100-lt_newmethod_ts train_batch_size=512 use_deepspeed=false log_class_dist=true log_generated_samples=true log_tsne=true num_runs=1 >& job_logs/imagenet-100-lt/newmethod_ts.out
