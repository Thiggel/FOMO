#!/bin/sh
#SBATCH --job-name=sota-cifar-100-lt-bridge-sdclr
#SBATCH --output=job_logs/sota/cifar-100-lt/bridge_sdclr_%A_%a.out
...
torchrun --standalone --nproc_per_node=${NPROC_PER_NODE} -m experiment \
    ...
    experiment_name=sota_cifar-100-lt_bridge-sdclr \
